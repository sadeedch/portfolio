...
const skills = [
  ...
  { name: "Power Platform", icon: <SiPowerapps />, color: "#742774" },
  { name: "Prisma", icon: <SiPrisma />, color: "#2D3748" },
  { name: "AG Grid", icon: <TbTable />, color: "#00AEEF" },
  { name: "Jest", icon: <SiJest />, color: "#C21325" },
  { name: "IIS", icon: <FaServer />, color: "#00A4EF" },
];
    ...
    <main className="portfolio">
      <style>{`
        ...
        .nav {
          ...
          background: rgba(2, 3, 13, 0.76);
          border-bottom: 1px solid var(--line);
          box-shadow: 0 12px 45px rgba(0,0,0,0.28);
        }

        .brand, .nav nav, .navActions {
          display: flex;
          align-items: center;
          gap: 14px;
        }
        ...
        .brandMark {
          ...
          height: 46px;
          color: #fff;
          border: 1px solid rgba(255,61,242,0.65);
          border-radius: 15px;
          background: linear-gradient(135deg, rgba(176,38,255,0.14), rgba(34,211,238,0.08));
          box-shadow: 0 0 22px rgba(255,61,242,0.55), inset 0 0 22px rgba(34,211,238,0.16);
          text-shadow: 0 0 12px var(--cyan), 0 0 22px var(--pink);
        }
        ...
        .sectionPad {
          padding: 96px clamp(18px, 5vw, 86px);
        }

        .sectionPadSmall {
          padding: 34px clamp(18px, 5vw, 86px);
        }
        ...
        .eyebrow {
          ...
          font-size: 13px;
          font-weight: 900;
          text-shadow: 0 0 16px rgba(255,61,242,0.78);
        ...
        .neonWhite {
          color: #fff;
          text-shadow: 0 0 12px #fff, 0 0 34px rgba(176,38,255,0.95);
        }

        .neonCyan {
          color: var(--cyan);
          text-shadow: 0 0 12px var(--cyan), 0 0 42px rgba(34,211,238,0.85);
        }
        ...
        .availability {
          ...
          box-shadow: inset 0 0 24px rgba(176,38,255,0.12), 0 0 22px rgba(176,38,255,0.14);
        }
        ...
        .availability span:not(.pulse):not(.miniIcon) {
          display: block;
          color: var(--text);
          font-family: 'SFMono-Regular', Consolas, monospace;
          font-size: 13px;
        ...
        .pulse {
          ...
          box-shadow: 0 0 0 0 rgba(55,255,139,0.7);
        ...
        .primary {
          ...
          color: #fff;
          border: 0;
          box-shadow: 0 0 24px rgba(176,38,255,0.55), 0 0 48px rgba(34,211,238,0.2);
        }
        ...
        .speech {
          ...
          background: rgba(14,8,35,0.86);
          color: #fff;
          font-family: 'SFMono-Regular', Consolas, monospace;
          line-height: 1.8;
          box-shadow: 0 0 28px rgba(255,61,242,0.38), inset 0 0 22px rgba(176,38,255,0.14);
        ...
        .speech::after {
          ...
          width: 24px;
          height: 24px;
          border-right: 1px solid rgba(255,61,242,0.7);
          border-bottom: 1px solid rgba(255,61,242,0.7);
          background: rgba(14,8,35,0.86);
        ...
        .orbitOne {
          width: 410px;
          height: 410px;
          box-shadow: 0 0 45px rgba(34,211,238,0.10);
        }
        ...
        .head {
          ...
          margin: 38px auto 0;
          border-radius: 46px;
          background: linear-gradient(145deg, #6d46ff, #15163b 45%, #030816 78%);
          border: 2px solid rgba(103,232,249,0.42);
          box-shadow: 0 0 34px rgba(124,60,255,0.62), inset 0 0 28px rgba(255,255,255,0.12);
        }

        .face {
          position: absolute;
          inset: 23px 18px 24px;
          border-radius: 34px;
          background: #030711;
          border: 1px solid rgba(34,211,238,0.28);
          box-shadow: inset 0 0 28px rgba(34,211,238,0.10);
        }
        ...
        .neck {
          ...
          height: 22px;
          margin: 0 auto;
          background: linear-gradient(90deg, #3e2bb8, #0a102a);
        ...
        .body {
          ...
          background: linear-gradient(145deg, #3d2ee6, #101530 64%, #060712);
          border: 2px solid rgba(103,232,249,0.34);
          box-shadow: 0 0 34px rgba(176,38,255,0.35), inset 0 0 22px rgba(255,255,255,0.08);
        }
        ...
        .screen {
          ...
          color: var(--cyan);
          font-weight: 900;
          box-shadow: inset 0 0 20px rgba(34,211,238,0.18), 0 0 18px rgba(34,211,238,0.22);
        }
        ...
        .arm {
          ...
          height: 96px;
          border-radius: 20px;
          background: linear-gradient(180deg, #6d46ff, #11152e);
          border: 1px solid rgba(103,232,249,0.24);
        }

        .leftArm { left: -30px; transform: rotate(16deg); }
        .rightArm { right: -30px; transform: rotate(-16deg); }
        ...
        .desk {
          ...
          height: 14px;
          border-radius: 999px;
          background: linear-gradient(90deg, transparent, rgba(34,211,238,0.7), rgba(255,61,242,0.6), transparent);
        ...
        .laptop {
          ...
          background: linear-gradient(145deg, #101635, #020612);
          border: 1px solid rgba(34,211,238,0.28);
        ...
        .statIcon {
          ...
          box-shadow: inset 0 0 18px rgba(34,211,238,0.12), 0 0 18px rgba(34,211,238,0.18);
          font-family: 'SFMono-Regular', Consolas, monospace;
        }
        ...
        .panel, .timelineCard, .projectCard, .contactCard, .proofCard {
          border: 1px solid var(--line);
          background: linear-gradient(180deg, rgba(5,10,30,0.86), rgba(3,7,20,0.72));
          backdrop-filter: blur(22px);
        ...
        .terminalText b {
          color: var(--green);
          text-shadow: 0 0 12px rgba(55,255,139,0.6);
        }
        ...
        .timelineCard:hover {
          ...
          box-shadow: 0 0 34px rgba(255,61,242,0.14);
        }
        ...
        .company {
          color: var(--pink);
          font-weight: 800;
          text-shadow: 0 0 10px rgba(255,61,242,0.45);
        }
        ...
        .skillTile:hover {
          ...
          box-shadow: 0 0 34px color-mix(in srgb, var(--skill-color) 35%, transparent);
        }
        ...
        .skillIcon {
          ...
          border-radius: 16px;
          border: 1px solid color-mix(in srgb, var(--skill-color) 48%, transparent);
          background: color-mix(in srgb, var(--skill-color) 12%, transparent);
          box-shadow:
            0 0 22px color-mix(in srgb, var(--skill-color) 28%, transparent),
            inset 0 0 18px color-mix(in srgb, var(--skill-color) 10%, transparent);
          font-size: 28px;
        }

        .skillTile span:last-child {
          color: #eef6ff;
          font-size: 14px;
          text-align: center;
        }
        ...
        .contactCard {
          ...
          border-radius: 30px;
          text-align: center;
          background: radial-gradient(circle at 20% 0%, rgba(176,38,255,0.26), transparent 28rem), linear-gradient(180deg, rgba(5,10,30,0.92), rgba(3,7,20,0.76));
        }

        .contactCard p:not(.eyebrow) {
          max-width: 820px;
          margin: 0 auto 28px;
          color: var(--muted);
          font-size: 18px;
        ...
        @keyframes pulse {
          0% { box-shadow: 0 0 0 0 rgba(55,255,139,0.6); }
          70% { box-shadow: 0 0 0 12px rgba(55,255,139,0); }
          100% { box-shadow: 0 0 0 0 rgba(55,255,139,0); }
        }
        ...
        @media (max-width: 1000px) {
          ...
          .robotScene { min-height: 500px; }
        }

        @media (max-width: 760px) {
          .nav nav, .navActions { display: none; }
          ...
          .projectsGrid, .valueGrid, .availabilityGrid, .statsRail {
            grid-template-columns: 1fr;
          }
      ...
      <header className="nav">
        <a className="brand" href="#top" aria-label="Sadeed Ahmad home">
        ...
        <div className="navActions">
          <a className="button ghost" href="mailto:sadeedahmadch@gmail.com">
            Let&apos;s talk
          </a>
        </div>
      </header>
      ...
      <section id="top" className="hero sectionPad">
        ...
        <div className="heroCopy reveal">
          ...
          <h1 className="neonTitle">
            <span className="neonWhite">I&apos;m Sadeed</span>
            <span className="neonCyan">
              Software Engineer
          ...
          <p className="lead">
            I build scalable, secure and high-performance software for healthcare,
            government and enterprise teams using React, Next.js, .NET, SQL Server,
          ...
          <div className="availabilityGrid">
            ...
            <div className="availability">
              ...
              <div>
                <strong>Based in Australia</strong>
                <span>Open to relocate Internationally</span>
              </div>
            </div>
          </div>
        ...
        <div className="reveal delayOne">
          ...
          <div className="statsRail">
            {stats.map((item) => (
              <div className="statPill" key={item.label}>
      ...
      <section id="about" className="sectionPad split">
        <div className="sectionIntro reveal">
          <p className="eyebrow">About Me_</p>
          <h2>
            I combine product thinking, enterprise discipline and hands-on
            engineering.
          </h2>
          <p>
            I am a Brisbane-based software engineer with strong experience across
            healthcare systems, public-sector software, frontend architecture,
            Microsoft technologies and workflow automation.
          </p>
        </div>

        <div className="panel terminalPanel reveal delayOne">
          ...
          <div className="terminalText">
            <span>
              &gt; role: <b>Senior Full Stack Developer</b>
            </span>
            <span>
              &gt; strength: <b>React + Next.js + .NET + SQL Server</b>
            </span>
            <span>
              &gt; domain: <i>Healthcare, public sector, enterprise systems</i>
            </span>
            <span>
              &gt; mindset:{" "}
              <b>Clean code. Reliable releases. Real user impact.</b>
            </span>
            <span>
              &gt; availability:{" "}
              <i>Remote worldwide, Australia-based, Europe relocation possible</i>
            </span>
          </div>
        </div>
      </section>

      <section className="sectionPad split">
        <div className="sectionIntro reveal">
          <p className="eyebrow">What I bring_</p>
          <h2>Not just coding, I help teams ship better software.</h2>
        </div>

        <div className="valueGrid reveal delayOne">
          {services.map((service) => (
            <div className="valueItem" key={service}>
              {service}
            </div>
          ))}
        </div>
      ...
      <section id="skills" className="sectionPad skillsSection">
        <div className="sectionIntro reveal">
          <p className="eyebrow">Tech Stack_</p>
          <h2>Modern full-stack delivery with strong Microsoft and frontend depth.</h2>
          <p>Tools I use to build, modernise, deploy and support production systems.</p>
        </div>

        <div className="skillGrid reveal delayOne">
          {skills.map((skill) => (
            <div
              className="skillTile"
              key={skill.name}
      ...
      <section id="projects" className="sectionPad projectsSection">
        <div className="sectionIntro centered reveal">
          <p className="eyebrow">Featured Projects_</p>
        </div>
      ...
      <section id="work" className="sectionPad timelineSection">
        <div className="sectionIntro centered reveal">
          <p className="eyebrow">Experience_</p>
          <h2>Real systems, real users, real impact.</h2>
          <p>
            My background spans healthcare, public-sector systems, workforce
            platforms and enterprise delivery.
          </p>
        </div>
      ...
      <section id="contact" className="sectionPad contactSection">
        <div className="contactCard reveal">
          <p className="eyebrow">Open to work internationally_</p>
          <h2>Need a developer who can ship, modernise and communicate clearly?</h2>
          <p>
            I am available for senior full-stack, frontend-heavy, Microsoft stack,
            healthcare, government and international remote opportunities. I can
            work from Australia or discuss relocation to Europe.
          </p>

          <div className="contactActions">
            <a className="button primary" href="mailto:sadeedahmadch@gmail.com">
              sadeedahmadch@gmail.com
            </a>
            <a className="button ghost" href="tel:+61450237005">
              +61 450 237 005
            </a>
            <a
              className="button ghost"
              href="https://www.linkedin.com/in/sadeedahmad/"
              target="_blank"
              rel="noreferrer"
            >
              LinkedIn profile
